      ...
      <div class="navbar-collapse">
        <ul class="nav navbar-nav navbar-right user-nav">
          <li class="dropdown profile_menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img alt="Avatar" src="images/<?php echo $datauser['profile_pic']; ?>" /><span>Jane Smith</span> <b class="caret"></b></a>
                ...
                <div class="nano nscroller">
                  <div class="content">
                    <ul>
                      ...
                      <li>
                        <a href="#">
                          <img  src="../images/<?php echo $data['profile_pic']; ?>" alt="avatar" /><span class="date pull-right">2 Nov.</span><span class="name">Lucy</span> Hello, my name is Lucy
                        </a>
                      </li>
                    </ul>
                  </div>
